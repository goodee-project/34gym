...
<meta charset="UTF-8">
    ...
    <title>Modify UniformRentalPrice</title>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb-text">
                        <h2>Modify UniformRentalPrice</h2>
                        <div class="bt-option">
                            <a href="${pageContext.request.contextPath}/admin/adminLogin">Home</a>
                            <a href="${pageContext.request.contextPath}/admin/getUniformRentalPriceList">UniformRentalPrice List</a>
                            <span>Modify UniformRentalPrice</span>
                        </div>
                    </div>
                </div>
            </div>
