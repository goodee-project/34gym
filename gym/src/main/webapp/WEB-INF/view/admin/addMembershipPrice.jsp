...
<title>Add MembershipPrice</title>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb-text">
                        <h2>Add MembershipPrice</h2>
                        <div class="bt-option">
                            <a href="${pageContext.request.contextPath}/admin/adminLogin">Home</a>
                            <a href="${pageContext.request.contextPath}/admin/getMembershipPriceList">Price</a>
                            <span>Add MembershipPrice</span>
                        </div>
                    </div>
                </div>
            </div>
