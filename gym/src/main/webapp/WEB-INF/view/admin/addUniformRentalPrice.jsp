...
<title>Add UniformRentalPrice</title>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb-text">
                        <h2>Add UniformRentalPrice</h2>
                        <div class="bt-option">
                            <a href="${pageContext.request.contextPath}/admin/adminLogin">Home</a>
                            <a href="${pageContext.request.contextPath}/admin/getUniformRentalPriceList">Price</a>
                            <span>Add UniformRentalPrice</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="leave-comment">
                        <form id="addForm" action="${pageContext.request.contextPath}/admin/addUniformRentalPrice" method="post">
                            <p>운동복 1개월 비용</p>
                            	<input type="text" name="uniformRentalPrice" id="membershipPrice" class="form-control">
                            <p>시작날짜</p>
