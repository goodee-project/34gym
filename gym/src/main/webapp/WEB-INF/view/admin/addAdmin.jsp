...
<body>
    ...
    <!-- 관리자 등록 Section Begin -->
	<section class="contact-section spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="leave-comment">
                        <form id="addForm" action="${pageContext.request.contextPath}/admin/addAdmin" method="post">
                            <p>이름</p>
                            	<input type="text" name="adminName" id="adminName">
                            <p>메일</p>
                            	<input type="text" name="adminMail" id="adminMail">
                            <p>비밀번호</p>
                            	<input type="text" name="adminPw" id="adminPw">
                            <p>주소</p>
