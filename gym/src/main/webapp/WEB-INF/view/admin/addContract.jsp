                ...
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb-text">
                        ...
                        <div class="bt-option">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/getContractList">Admin</a>
                ...
                <div class="col-lg-12">
                    <div class="leave-comment">
                        <form id="addForm" action="${pageContext.request.contextPath}/admin/addContract" method="post">
                            ...
                            <p>로열티</p>
                            	<input type="text" name="contractLoyalty" id="contractLoyalty">
                            <p>계약기간</p>
                            	<input type="text" name="contractDuration" id="contractDuration">
                            <p>계약금</p>
                            	<input type="text" name="contractDeposit" id="contractDeposit">
