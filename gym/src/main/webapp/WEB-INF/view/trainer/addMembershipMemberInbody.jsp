...
<title>Add MembershipMemberInbody</title>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb-text">
                        <h2>Add MembershipMemberInbody</h2>
                        <div class="bt-option">
                            <a href="${pageContext.request.contextPath}/admin/adminLogin">Home</a>
                            <a href="${pageContext.request.contextPath}/admin/addMembershipMemberInbody">Inbody</a>
                            <span>Add MembershipMemberInbody</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="leave-comment">
                        <form id="addForm" action="${pageContext.request.contextPath}/trainer/addMembershipMemberInbody" method="post">
                        	<p>출입기록</p>
								<input type="text" name="membershipMemberEntranceRecordId" class="form-control">
                            <p>트레이너</p>
